...
@app.get("/exclusion", status_code=200)
...
@app.post("/exclusion", status_code=204)
...
@app.delete("/exclusion", status_code=200)
async def clear_active_exclusion_list():
    _log.info(f'Delete Active Exclusion List')
    return active_exclusion_list.clear()


@app.delete("/exclusion/file", status_code=200)
...
@app.get("/exclusion/file", status_code=200)
...
@app.post("/exclusion/file", status_code=204)
...
@app.head("/exclusion/interval", status_code=200)
...
async def add_interval(interval_id: str | None = None, charge: int | None = None, min_mass: float | None = None,
                       max_mass: float | None = None, min_rt: float | None = None, max_rt: float | None = None,
                       min_ook0: float | None = None, max_ook0: float | None = None, min_intensity: float | None = None,
                       max_intensity: float | None = None):
...
async def remove_interval(interval_id: str | None = None, charge: int | None = None, min_mass: float | None = None,
                          max_mass: float | None = None, min_rt: float | None = None, max_rt: float | None = None,
                          min_ook0: float | None = None, max_ook0: float | None = None,
                          min_intensity: float | None = None, max_intensity: float | None = None):
    exclusion_interval = ExclusionInterval(id=interval_id, charge=charge, min_mass=min_mass, max_mass=max_mass,
    ...
    return active_exclusion_list.remove(exclusion_interval)


@app.get("/exclusion/point", response_model=List[ExclusionInterval], status_code=200)
...
@app.head("/exclusion/point", status_code=200)
...
@app.get("/exclusion/points", response_model=List[bool], status_code=200)
